...
const get_transactions_admin = base_url + "/transactions";
const get_tran_five = base_url + "/transactions/getFive";
...
const displayBilling = async () => {
    const transactions = await fetchAPI(get_transactions_admin);
...
function displayTransaction(transactions) {
    ...
    transactions.forEach(tran => {
        ...
        const salespersonName = document.createElement('h6');
        salespersonName.className = 'mb-3 text-sm';
        salespersonName.textContent = "Salesperson: " + tran.salesperson.fullname;
        ...
        customerInfoDiv.appendChild(salespersonName);
